...
namespace Ugc\Component\Ugc_new\Administrator\View\Reviews;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_UGC_NEW_TITLE_REVIEWS'), "generic");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_ugc_new&view=reviews');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`created_at`' => Text::_('COM_UGC_NEW_REVIEWS_CREATED_AT'),
			'a.`trip_code`' => Text::_('COM_UGC_NEW_REVIEWS_TRIP_CODE'),
			'a.`rating`' => Text::_('COM_UGC_NEW_REVIEWS_RATING'),
			'a.`review_title`' => Text::_('COM_UGC_NEW_REVIEWS_REVIEW_TITLE'),
			'a.`user_name`' => Text::_('COM_UGC_NEW_REVIEWS_USER_NAME'),
		);
	}
