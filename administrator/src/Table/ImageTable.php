 ...
 * @since 1.0.0
 */
class ImageTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ugc_new.image';
		parent::__construct('#__ugc_images', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		// Support for multiple or not foreign key field: review_id
			if(!empty($array['review_id']))
			{
				if(is_array($array['review_id'])){
					$array['review_id'] = implode(',',$array['review_id']);
				}
				else if(strrpos($array['review_id'], ',') != false){
					$array['review_id'] = explode(',',$array['review_id']);
				}
			}
			else {
				$array['review_id'] = 0;
		...
		if (!$user->authorise('core.admin', 'com_ugc_new.image.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ugc_new/access.xml',
				"/access/section[@name='image']/"
			);
			$default_actions = Access::getAssetRules('com_ugc_new.image.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	public function check()
	{
		...
		if ($files['image1'][0]['size'] > 0)
		{
			...
			{
				$oldFile = JPATH_ROOT . '/images/ugc/' . $f;
			...
			foreach ($files['image1'] as $singleFile )
			{
				...
				else
				{
					...
					$uploadPath = JPATH_ROOT . '/images/ugc/' . $filename;
    ...
    public function delete($pk = null)
    {
		...
		if ($result)
		{
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image1);
			break;
			default:
			foreach ($this->image1 as $image1File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image1File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image2);
			break;
			default:
			foreach ($this->image2 as $image2File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image2File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image3);
			break;
			default:
			foreach ($this->image3 as $image3File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image3File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image4);
			break;
			default:
			foreach ($this->image4 as $image4File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image4File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image5);
			break;
			default:
			foreach ($this->image5 as $image5File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image5File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image6);
			break;
			default:
			foreach ($this->image6 as $image6File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image6File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image7);
			break;
			default:
			foreach ($this->image7 as $image7File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image7File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image8);
			break;
			default:
			foreach ($this->image8 as $image8File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image8File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image9);
			break;
			default:
			foreach ($this->image9 as $image9File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image9File);
			}
			}
			jimport('joomla.filesystem.file');
			...
			{
			case 'string':
				File::delete(JPATH_ROOT . '/images/ugc/' . $this->image10);
			break;
			default:
			foreach ($this->image10 as $image10File)
			{
				File::delete(JPATH_ROOT . '/images/ugc/' . $image10File);
			}
			}
		}
